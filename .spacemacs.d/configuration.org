...
#+begin_src emacs-lisp :results none
  (defun jm/org-sync ()
    ...
    (shell-command "~/.bin/org-sync &")

  (run-with-timer 300 300 'jm/org-sync)
#+end_src
...
*** Capture Templates
    #+begin_src emacs-lisp :results none
      ...
      (defun jm/org-common-template (prefix)
        (format ""))
...
* Keyboard Bindings
  #+begin_src emacs-lisp :results none
    ...
    (global-set-key (kbd "H-<backspace>") (kbd "C-c C-k"))
